...
||int x = `0b`1011; → 10진수 값 = 1x2³ + 0x2² + 1x2¹ + 1x2⁰ = 11<br> int y = `0B`10100; → 10진수 값 = 1|
|8진수|0으로 시작하고 0 ~ 7 숫자로 작성|
||int x = `0`13; <br> int y = `0`206; 2**2²
<!--stackedit_data:
eyJoaXN0b3J5IjpbODUxMDkzNjAsNjcwOTU0MDkzLDE5MTY4Nj
E5OTcsMTY5Nzk4MjUxNSwxNTc2MjQyOTc3LC01MjAxODM4MDUs
LTE5NTA2MzAyMTUsLTgxMzY4NzUzNSwtNTgwMTc5MzQ2LDEwMT
M1MjA0MjZdfQ==
-->